...
public class Way2SMS {
    ...
    public String loginWay2SMS(String userName,String password)
    {
        ...
        try {
            ...
            urlLogin=new URL("http://site24.way2sms.com/content/Login1.action");
            if(proxy==null)
            {
    ...
    public void sendSMS(String phoneNumber,String message,String action)
    {
            ...
            try {
                ...
                sendURL=new URL("“http://site24.way2sms.com/Login1.action");
                if(proxy==null)
                {
    ...
    {  
        final String USERNAME="7306827578";//REQUIRED
        final String PASSWORD="prathap123";//REQUIRED
        final String ACTION="Notify";//REQUIRED : In order to understand ACTION value please read the blog
       ...
       /* StringBuilder phoneNumber= new StringBuilder();
        ...
        arrPhoneNUmber[0]="8522945061";
       // arrPhoneNUmber[0]="7306827578";
        for(int i=0;i<arrPhoneNUmber.length;i++)
        {
         
         sms.sendSMS(arrPhoneNUmber[i], "Hai Ra how are you", "notification");
        }
        */
/*        sms.logoutWay2SMS();*/
        
        sms.loginWay2SMS("7306827578", "prathap123");
        sms.sendSMS("8522945061", "hi Prathap", "refer");
    }
}