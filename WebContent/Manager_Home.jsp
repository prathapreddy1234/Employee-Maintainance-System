...
<body>
		...
		<div class="navbar navbar-btn navbar-fixed-top" id="header"
			...
			<div  class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav head-nav">
					...
					<li><a href="#requests" id="requestsbtn"
						data-toggle="collapse" data-target="d0">Requests</a></li>
	...
	<div class="btns btns-body">
		...
		<div class="col-sm-10 col-md-10 well" id="requests">
		...
		<div class="col-sm-5 col-md-5 well" id="editprofile">
				<form>
					...
					<div class="form-group ">
						<input type="button" id="updatembtn" class="btn btn-primary "
							value="Update">
...
<div class="col-sm-10 col-md-10 well" id="changeMPass">																			<!-- change password -->
					<form>
						<div class="form-group">
							<label for="name" class="cols-sm-10 control-label">Old Password</label><span id="molderr"></span>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										aria-hidden="true"></i></span><input type="password"
										class="form-control" name="oldpass" id="oldpass" onkeyup="validateMOld()" onblur="oldValids()"
						...
						<div class="form-group">
							<label for="username" class="cols-sm-10 control-label">Confirm Password</label><span id=""></span> 
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-users fa" aria-hidden="true"></i></span> <input
										type="password" class="form-control" name="cnfnewpass" id="cnfpass" onkeyup="validateNew()"
										placeholder="Confirm new Password" /><span id="output"></span>
								</div>
							</div>
						</div>
	...
	<div class="col-md-4">
			<div class="aro-pswd_info">
				<div id="edit_manager_phone_info">
					<ul>
						<li id="m_editphonestartvalids" class="invalid">Must start with <strong>one 9 or 8 or 7</strong></li>
						<li id="m_editphonetenvalids" class="invalid">Must be <strong> ten digits</strong></li>
					</ul>
				</div>
			</div>
		</div>
