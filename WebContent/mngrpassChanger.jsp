...
Statement st=con.createStatement();
                    ...
                    rs = st.executeQuery("select * from employees where password='"+opass+"' and sno='"+session.getAttribute("ID")+"'");   
                    if(rs.next())
                    {    
                        out.println("<font color=green>");
                        out.println("<h4> Old Password Matched</h4>");
                        out.println("</font>");
 
                    }else {
 
                        out.println("<font color=red>");
                        out.println("<h4>Old Password Not Matched</h4>");
                        out.println("</font>");
                    }
